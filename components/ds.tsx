 ...
 * @param {string} [props.id] - HTML id attribute.
 * @param {React.CSSProperties} [props.style] - Inline styles.
 * @param {string} [props.size] - Max width size variant.
 * @returns {JSX.Element} A div element acting as a container.
 */

type ContainerSize = "2xl" | "3xl" | "4xl" | "5xl";
...
export const Container = ({
  ...
  style,
  size = "5xl",
}: DSProps & { size?: ContainerSize }) => (
  <div
    className={cn(containerSizes[size], "mx-auto p-4 sm:p-6", className)}
    id={id}
    style={style}
  >
    {children}
...
/**
 * Center component for full-screen centered layouts (auth, error pages).
 *
 * @param {DSProps} props - Component props.
 * @param {React.ReactNode} props.children - Child elements.
 * @param {string} [props.className] - Additional class names.
 * @param {string} [props.id] - HTML id attribute.
 * @param {React.CSSProperties} [props.style] - Inline styles.
 * @returns {JSX.Element} A div element with centered content.
 */
